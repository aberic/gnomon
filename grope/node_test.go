...
func TestNodeSupport(t *testing.T) {
	root := newNode()
	root.add("/a/b/c/d", http.MethodPost, nil, nil, nil)
	root.add("/a/b/c/d", http.MethodPut, nil, nil, nil)
	root.add("/a/b/c/d", http.MethodPatch, nil, nil, nil)
	root.add("/a/b/c/d/:e", http.MethodPost, nil, nil, nil)
	root.add("/a/b/c/d/e/f", http.MethodPost, nil, nil, nil)
	root.add("/a/:b/c/:d/e/f/g", http.MethodPost, nil, nil, nil)
	t.Log("=============")
...
func TestNodeQA(t *testing.T) {
	root := newNode()
	root.add("/v1/company/:companyID/platforms", http.MethodGet, nil, nil, nil)
	root.add("/v1/company/:companyID/platforms", http.MethodPost, nil, nil, nil)
	root.add("/v1/login", http.MethodPost, nil, nil, nil)
	root.add("/v1/company/:companyID/platforms/members/invitations", http.MethodPost, nil, nil, nil)
	root.add("/v1/company/:companyID/platforms/:platformID", http.MethodPut, nil, nil, nil)
	t.Log("=============")
